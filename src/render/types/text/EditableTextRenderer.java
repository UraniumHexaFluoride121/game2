...
public class EditableTextRenderer extends FixedTextRenderer implements ButtonInputReceiver, Deletable {
    ...
    public EditableTextRenderer setMaxTextWidth(float maxTextWidth) {
    ...
    protected void updateText(Graphics2D g) {
        super.updateText(g);
        if (maxTextWidth != 0 && text != null && getTextWidth() > maxTextWidth) {
            removeChar();
            updateText(g);
    ...
    public EditableTextRenderer setOnChanged(Runnable onChanged) {
