...
public class LevelUIContainer extends UIContainer {
    public Level level;

    public LevelUIContainer(RenderRegister<OrderedRenderable> register, ButtonRegister buttonRegister, RenderOrder order, ButtonOrder buttonOrder, float x, float y, BiConsumer<GameRenderer, ButtonRegister> createRenderer, Level level) {
        super(register, buttonRegister, order, buttonOrder, x, y, createRenderer);
        this.level = level;
    }

    public LevelUIContainer(RenderRegister<OrderedRenderable> register, ButtonRegister buttonRegister, RenderOrder order, ButtonOrder buttonOrder, float x, float y, Level level) {
