...
public enum UnitAttribute implements ColouredIconName {
    ...
    UnitAttribute(StyleElement colour, TextRenderable icon, String displayName, Function<UnitAttribute, String> description) {
        this.colour = colour;
        this.icon = icon;
